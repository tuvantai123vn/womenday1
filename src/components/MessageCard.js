...
const messages = [
  "Chúc mừng ngày 8/3! Chúc các chị em luôn xinh đẹp, hạnh phúc và thành công!",
  "Ngày 8/3 thật rực rỡ nhé! Chúc chị em luôn vui vẻ, mạnh mẽ và được yêu thương!",
  "Chúc các chị em một ngày 8/3 tràn đầy niềm vui và hạnh phúc!",
  "Happy Women's Day 8/3! Chúc một nửa thế giới luôn tỏa sáng và hạnh phúc!",
  "Ngày đặc biệt này là dành cho các chị em! Chúc mọi điều tốt đẹp nhất sẽ đến với các bạn!",
  "Chúc chị em ngày 8/3 thật ý nghĩa, luôn yêu thương bản thân và tận hưởng cuộc sống trọn vẹn!"
];
